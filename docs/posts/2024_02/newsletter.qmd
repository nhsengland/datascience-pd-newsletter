...
Analytics is the the first compentency in our [Comptency Framework](https://nhsd-confluence.digital.nhs.uk/display/DAT/Data+Science+Competency+Framework){target="_blank"}❗ and is all about levereging Data Science techniques to develop actionable insights from complex datasets, driving informed decision-making and value creation.
These include:

- Knowledge and application of data science & machine learning techniques (including but not limited to NLP, geospatial analysis, information retrieval & search, hypothesis testing, simulation and data linkage)
...
### [Improve your Markdown by contributing to the Data Science website](https://nhsengland.github.io/datascience/)!
Ever wanted to try your hand at learning Markdown but never really found a reason? 
Check out this [Markdown tutorial](https://www.markdowntutorial.com/){target="_blank"} before 

|  | |
|-------|------|
|<img src="amaia_website_newsletter.png" alt="Newsletter Image" width="350"> | We launched the prototype [Data Science website](https://nhsengland.github.io/datascience/) - but now we need your help. <br>Generally, we need contributions to the website (see how to do this [here](https://github.com/nhsengland/datascience/blob/main/CONTRIBUTE.md)), in particular:<br><br>- Send us a summary of your project (see [this example](https://nhsengland.github.io/datascience/our_work/ds218_rap_community_of_practice/))<br>- Follow [this template](https://github.com/nhsengland/datascience/blob/main/docs/our_work/template-project.md).<br>- Contribute an article to the blog.<br>- Volunteer to pick up an [issue](https://github.com/nhsengland/datascience/issues) on GitHub.<br>- Give us feedback about the [website](https://nhsengland.github.io/datascience/).<br><br>**You’ve got lots to gain too**: It's crucial people know about our work, and with the conference seasons approaching, having something up on the web means you've got something nice to point people to!<br><br>**So don't delay -** in the next few weeks find an hour to bash together a summary of your project and get in touch with the marketing team (or try and raise a pull request to add it yourself!). |
