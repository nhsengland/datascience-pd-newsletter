...
As you prepare for future career opportunities within NHSE, it's crucial to explore and understand the job descriptions available to you for when roles become available. Take a look at the [job descriptions saved on Confluence](https://nhsd-confluence.digital.nhs.uk/display/DAT/Data+Science+Job+Descriptions){target="_blank"} which provide insight into the requirements and expectations for the various roles we have in the team. By familiarising yourself with these expectations, you can  plan your professional development and tailor your training to align with the roles you aim to apply for.
