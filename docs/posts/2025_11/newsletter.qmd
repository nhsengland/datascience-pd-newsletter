...
- [The Neurodiversity Network on NHS Futures](https://future.nhs.uk/NeurodiversityNetwork){target='_blank'}: A supportive community for neurodivergent staff and allies across the NHS, offering resources, discussion forums, and networking opportunities to promote understanding and inclusivity in the workplace. 
- [The Python Graph Gallery](https://python-graph-gallery.com/){target='_blank'}:  A comprehensive collection of data visualisation examples with Python code, covering everything from basic charts to advanced statistical graphics. Perfect for finding inspiration and learning how to implement different chart types using libraries like Matplotlib, Seaborn, and Plotly.  
- [The HSMA Course](https://sites.google.com/nihr.ac.uk/hsma/home){target='_blank'}: The Health Service Modelling Associates programme offers free training in operational research, data science, and simulation modelling specifically for healthcare. Their extensive back catalogue of projects, open-source code repositories, and textbooks provides invaluable resources for understanding how to apply analytical techniques to real-world health and care challenges.
- [NHS-R Community](https://nhsrcommunity.com/){target='_blank} & [NHS Python Community](https://nhs-pycom.net/){target='_blank'} (merging to become NHS Open Analytics): Two vital open communities of practice that champion the use of R and Python in the NHS and wider health and care sector. They offer training, conferences, blogs, Slack channels, and collaborative projects to help analysts and data scientists develop their technical skills and share best practice. The communities are currently merging to form NHS Open Analytics (NHS OA), which will unite these communities under one umbrella. 
- [The RAP Community of Practice](https://nhsdigital.github.io/rap-community-of-practice/){target='_blank'}: The go-to resource for learning Reproducible Analytical Pipelines. RAP is a set of principles and techniques using open-source tools to make analytical work more efficient, transparent, and less error-prone. The site offers comprehensive guidance, training materials for Git, Python, R, and PySpark, plus the NHS England Data Science team provides hands-on support to teams implementing RAP. 
 
___

We hope you found this interview with Sean Aller insightful.

His journey from academia through teaching to healthcare data science demonstrates the value of embracing new challenges and the unexpected opportunities that arise along the way. Sean's contributions to both technical projects like CVD Prevent and cultural initiatives like the Neurodiversity Staff Network show how data scientists can make a lasting impact beyond their analytical work.

We wish Sean all the best in his new role at the Financial Conduct Authority and look forward to seeing how he continues to drive positive change through data science.
