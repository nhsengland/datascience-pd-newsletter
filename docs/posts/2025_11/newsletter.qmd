...
- [The Neurodiversity Network on NHS Futures](https://future.nhs.uk/NeurodiversityNetwork){target='_blank'}: A great community.  
- [The Python Graph Gallery](https://python-graph-gallery.com/){target='_blank'}: Excellent for learning new visualisation techniques.  
- [The HSMA Course](https://sites.google.com/nihr.ac.uk/hsma/home){target='_blank'}: Great for learning about health data and the healthcare system in the UK. Their back catalogue of projects and books is a great free resource to tap into.  
...
We hope you found this interview with Sean Aller insightful. His journey from academia through teaching to healthcare data science demonstrates the value of embracing new challenges and the unexpected opportunities that arise along the way. Sean's contributions to both technical projects like CVD Prevent and cultural initiatives like the Neurodiversity Staff Network show how data scientists can make a lasting impact beyond their analytical work. We wish Sean all the best in his new role at the Financial Conduct Authority and look forward to seeing how he continues to drive positive change through data science.
