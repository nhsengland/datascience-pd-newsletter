...
Last month we ran another Data Science Discussion, an event where we have a host prepare a topic for discussion and then split into breakout rooms to allow more people to have the chance to have their say. These discussions aren't recorded, we want to make everyone feel as comfortable as possible to discuss their thoughts and ideas on whatever topic we are talking about.
