...
Had to pick between two presentations on at the same time? Couldn't make the event in person? No worries - the Health and Care Analytics conference hosted in July recorded all their presentations and has now uploaded them onto their YouTube channel, and can be easily accessed from [their site](https://haca-conference.nhs.uk/programme/){target="_blank"}.
