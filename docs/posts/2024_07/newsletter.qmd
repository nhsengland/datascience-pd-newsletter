...
In July, the NHS England Data Science Professional Development Functional Team hosted a school placement, hosting five students from a London based secondary school to teach them about our work and show them some of the skills they would need to start a career in data science.

This was a diffcult task, involving a lot of admin, paperwork, and even a conversation with NHS England lawyers to check we were dotting all our i's and crossing all our t's.

-	Student experience (attached): We introduced two methods of data science ways of working: python programming and collaborative works on GitHub. Students had a rotation of four data science teams to link up their learnings. At the end of the placement week, they had a mock interview and an optional task to build a classifier function with if-else conditions to find which group (of the sessions) they could match the session information.
-	Impact on the team: It was the first host experience since post-merger; not only as a data science team but also first for the entire NHS England! About half of the data scientists (a total of 22) met students during the placement week alongside more indirect engagements from others such as helping with the training materials. Evaluated this as a good trial to address the fair opportunity for the community to get work experience opportunity without worries about individual friendships or lack of working devices; we found Inspiring the Future and made the school provide the laptops.


As this was the first of it's kind, it took a while to discover all the rules and policies. Now we have done this once, subsequent placements should be a lot easier to host. 
