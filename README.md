...
- Take a look at the [PD GitHub](https://github.com/nhsengland/PD_kanban_board/blob/main/PD%20Files/Resources/newsletter.md) for details on what to add to the newsletter.
